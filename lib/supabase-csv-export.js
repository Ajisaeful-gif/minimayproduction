...
function buildReadmeContent(tables) {
  ...
  return [
    ...
    "1. Jalankan schema.sql terlebih dulu di Supabase SQL Editor.",
    "2. Jangan gunakan Create table from CSV.",
    "3. Import CSV ke tabel existing yang sudah dibuat oleh schema.sql.",
    "4. Pertahankan kolom id/user_id dari hasil export agar foreign key tetap cocok.",
    "5. Import user.csv, profile.csv, account.csv.",
    "6. session.csv dan verification.csv opsional bila tetap kosong.",
    "7. Import master data: sku_master, kode_pola_master, jenis_kain_master, operator_master.",
    "8. Import tabel header proses lalu tabel row/detail-nya.",
    "",
